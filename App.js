...
export default function App() {
  ...
  const [ip, setIp] = useState('10.20.102.199');
...
/////////////////////////////////////////////////
  ...
  return (
    <LocationContext.Provider value={{ location, setLocation, userId, setUserId, userEmail, setUserEmail, ip, setIp, locstate, setLocstate, profileImage, setProfileImage, expoPushToken, setExpoPushToken }}>
      <NavigationContainer>
